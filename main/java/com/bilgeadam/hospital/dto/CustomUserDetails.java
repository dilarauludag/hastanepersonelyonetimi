package com.bilgeadam.hospital.dto;
...
public class CustomUserDetails implements UserDetails {
	...
	@Override
	// <? extends GrantedAuthority> yazımının açılımı: Buraya yazılabilecek sınıflar 
	//GrantedAuthority interface ini implemente etmesi şarttır veya implemente eden herhangi bir sınıf kullanılabilir.
